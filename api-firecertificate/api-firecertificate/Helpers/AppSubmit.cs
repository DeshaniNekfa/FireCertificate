...
namespace api_rate.Helpers
{
    public class AppSubmit : IAppSubmit
    {
        ...
        public bool SetStatusPaid(FireCertificateApplication objFireApp, ref ReturnMsgInfo objReturnMsg)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    if (this.mySqlCon != null)
                    {
                        strSql = "UPDATE tbl_firecertificate_application SET Status = 'Paid', WHERE CertificateId = '" + objFireApp.CertificateId + "';";
                        cmd = new MySqlCommand(strSql, this.mySqlCon, this.mySqlTrans);
                        cmd.ExecuteNonQuery();
                        isApporoved = true;
        ...
        public bool SetStatusPaidForCert(FireCertificateApplication objFireApp, ref ReturnMsgInfo objReturnMsg)
        {
            bool isApporoved = false;
            this.objConMain = new Connection_Main();
            ...
            try
            {
                ...
                else
                {
                    ...
                    if (this.mySqlCon != null)
                    {
                        ...
                        objReturnMsg.ReturnValue = "OK";
                        objReturnMsg.ReturnMessage = "Set status successfully";
                    }
                }
            }
            catch (Exception ex)
        ...
        public bool SetCollectMethod(FireCertificateApplication objFireApp, ref ReturnMsgInfo objReturnMsg)
        {
            bool isApporoved = false;
            this.objConMain = new Connection_Main();
            ...
            try
            {
                ...
                else
                {
                    ...
                    if (this.mySqlCon != null)
                    {
                        strSql = "UPDATE tbl_firecertificate_application SET CollectMethod = '"+objFireApp.CollectMethod+"' WHERE Id = '" + objFireApp.Id + "';";
                        cmd = new MySqlCommand(strSql, this.mySqlCon, this.mySqlTrans);
                        cmd.ExecuteNonQuery();
                        isApporoved = true;
